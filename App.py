...
st.set_page_config(page_title="Eric Agro - Sistema de Receitas", page_icon="🚜", layout="wide")
...
st.title("🚜 Central de Mistura Eric - Gestão de Receitas")
...
with st.sidebar:
    st.header("📋 Operação")
    # Se carregou arquivo, usa o valor dele, senão usa o padrão
    ...
    for i in range(n_prod):
        ...
        # Tenta pegar o produto da receita carregada
...
# --- BOTÃO DE SALVAR (DENTRO DO EXPANDER) ---
with col_save:
